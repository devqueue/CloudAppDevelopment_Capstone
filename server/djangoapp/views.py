...
def get_dealerships(request):
    if request.method == "GET":
        ...
        url = "https://49c54959.eu-gb.apigw.appdomain.cloud/api/get-dealership"
...
def get_dealer_details(request, dealer_id):
    if request.method == "GET":
        context = {}
        url = "https://49c54959.eu-gb.apigw.appdomain.cloud/api/get-review"
...
def add_review(request, dealer_id):
    ...
    if request.method == "POST" and request.user.is_authenticated:
        url = "https://49c54959.eu-gb.apigw.appdomain.cloud/api/post-review"
        review_payload = dict()
